...
const LoadingState: React.FC = () => {
    const messages = useMemo(() => [
        ...
        "Finding your Moon's position...",
        "Generating your emotional profile...",
    ], []);
    ...
    return (
        <div className="flex flex-col items-center justify-center h-full p-8 text-center min-h-[60vh]">
            ...
            <h1 className="font-serif text-3xl font-bold text-brand-text-primary mt-8">Finding Your Rashi</h1>
...
const Report: React.FC<{ data: KundliData, onReset: () => void }> = ({ data, onReset }) => {
    return (
        <div className="max-w-2xl mx-auto bg-brand-card p-8 rounded-xl shadow-md mt-6 text-center animate-fade-in">
            <p className="text-brand-text-secondary">Your Moon Sign (Rashi) is</p>
            <h2 className="font-serif text-5xl font-bold text-brand-primary my-2">{data.basicDetails.moonSign}</h2>
            <div className="text-left mt-6 bg-brand-surface p-4 rounded-lg">
                <h3 className="font-bold text-brand-text-primary mb-2">How your Rashi shapes you:</h3>
                <p className="text-brand-text-secondary leading-relaxed">{data.rashiAnalysis}</p>
            </div>
...
export const RashiCalculatorPage: React.FC = () => {
    ...
    return (
        <div>
            <header className="mb-6 text-center">
                <h1 className="font-serif text-3xl sm:text-4xl font-bold text-brand-text-primary">Rashi Calculator</h1>
                <p className="text-brand-text-secondary mt-1 max-w-lg mx-auto">Your Rashi, or Moon Sign, governs your mind, emotions, and inner self. Find yours to understand your core nature.</p>
            </header>
